...
| Install version stamp | `lazycodex-install.json` | `lfg-install.json` (Grok plugin root) | partial (`plugin-cache-install.acceptance.test.ts` #27; `registry-bin-publish-gap.test.ts` #22; npm publish) |
