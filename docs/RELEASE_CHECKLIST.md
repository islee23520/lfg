...
- [ ] Real Grok install smoke emits `grok-install-smoke=ok skills=17 key_skills_present` when a Grok install is available.
...
The real Grok inspect smoke must discover exactly 17 skills from the plugin, including:
