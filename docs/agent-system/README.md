...
## Legacy / Historical Agent Lineup (pre-OMO)

| Agent Name | Role                  | Philosophy / Strength                  | Preferred Category | Notes |
|------------|-----------------------|----------------------------------------|--------------------|-------|
| **lina**   | Orchestrator (Leader) | Historical custom orchestrator name | - | Removed from active team specs |
| **gonow**  | Workers / Executors   | Historical worker name | quick / balanced | Removed from active team specs |
