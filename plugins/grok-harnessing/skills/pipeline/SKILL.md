---
name: pipeline
description: "Grok Build port of OMX `pipeline`: Configurable pipeline orchestrator for sequencing stages"
user_invocable: true
metadata:
  package: "linalab-io-framework/grok-build"
  source: "oh-my-codex/plugins/oh-my-codex/skills/pipeline/SKILL.md"
  source_repo: "https://github.com/Yeachan-Heo/oh-my-codex"
  port_kind: "grok-skill-adapter"
---

# Pipeline Skill — Grok Build Port

This skill is the Grok Build adaptation of the OMX `pipeline` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/pipeline/SKILL.md`
- Original description: Configurable pipeline orchestrator for sequencing stages
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/pipeline/` when state is needed.
