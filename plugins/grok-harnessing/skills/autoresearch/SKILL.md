---
name: autoresearch
description: "Grok Build port of OMX `autoresearch`: Stateful validator-gated research loop with native-hook persistence"
user_invocable: true
metadata:
  package: "linalab-io-framework/grok-build"
  source: "oh-my-codex/plugins/oh-my-codex/skills/autoresearch/SKILL.md"
  source_repo: "https://github.com/Yeachan-Heo/oh-my-codex"
  port_kind: "grok-skill-adapter"
---

# Autoresearch — Grok Build Port

This skill is the Grok Build adaptation of the OMX `autoresearch` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/autoresearch/SKILL.md`
- Original description: Stateful validator-gated research loop with native-hook persistence
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/autoresearch/` when state is needed.
