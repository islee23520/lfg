---
name: skill
description: "Grok Build port of OMX `skill`: Manage local skills - list, add, remove, search, edit, setup wizard"
user_invocable: true
metadata:
  package: "linalab-io-framework/grok-build"
  source: "oh-my-codex/plugins/oh-my-codex/skills/skill/SKILL.md"
  source_repo: "https://github.com/Yeachan-Heo/oh-my-codex"
  port_kind: "grok-skill-adapter"
---

# Skill Management CLI — Grok Build Port

This skill is the Grok Build adaptation of the OMX `skill` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/skill/SKILL.md`
- Original description: Manage local skills - list, add, remove, search, edit, setup wizard
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/skill/` when state is needed.
