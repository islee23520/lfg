...
# plan — Grok Build Port

This skill is the Grok Build adaptation of the OMX `plan` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/plan/SKILL.md`
- Original description: Strategic planning with optional interview workflow
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/plan/` when state is needed.
