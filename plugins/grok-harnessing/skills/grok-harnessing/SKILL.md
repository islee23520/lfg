---
name: grok-harnessing
description: Stress-test and harden Grok Build-compatible plugin surfaces: skills, hooks, MCP/LSP configs, marketplace metadata, and Claude Code / AGENTS compatibility.
user_invocable: true
metadata:
