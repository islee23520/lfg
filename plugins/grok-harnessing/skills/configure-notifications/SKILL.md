...
# Configure OMX Notifications — Grok Build Port

This skill is the Grok Build adaptation of the OMX `configure-notifications` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/configure-notifications/` when state is needed.
