---
name: cancel
description: "Grok Build port of OMX `cancel`: Cancel any active OMX mode (autopilot, ralph, ultrawork, ecomode, ultraqa, swarm, ultrapilot, pipeline, team)"
user_invocable: true
metadata:
...
# Cancel Skill — Grok Build Port

This skill is the Grok Build adaptation of the OMX `cancel` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/cancel/SKILL.md`
- Original description: Cancel any active OMX mode (autopilot, ralph, ultrawork, ecomode, ultraqa, swarm, ultrapilot, pipeline, team)
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/cancel/` when state is needed.
