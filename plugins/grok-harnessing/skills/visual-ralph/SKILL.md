---
name: visual-ralph
description: "Grok Build port of OMX `visual-ralph`: Visual Ralph orchestration for frontend UI from generated references, static references, or live URL targets, using $ralph with built-in visual verdict and pixel-diff evidence until the implementation matches and leaves a reproducible design system."
user_invocable: true
metadata:
  package: "linalab-io-framework/grok-build"
  source: "oh-my-codex/plugins/oh-my-codex/skills/visual-ralph/SKILL.md"
  source_repo: "https://github.com/Yeachan-Heo/oh-my-codex"
  port_kind: "grok-skill-adapter"
---

# Visual Ralph Skill — Grok Build Port

This skill is the Grok Build adaptation of the OMX `visual-ralph` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/visual-ralph/SKILL.md`
- Original description: Visual Ralph orchestration for frontend UI from generated references, static references, or live URL targets, using $ralph with built-in visual verdict and pixel-diff evidence until the implementation matches and leaves a reproducible design system.
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/visual-ralph/` when state is needed.
