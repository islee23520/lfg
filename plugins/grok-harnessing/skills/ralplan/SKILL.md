...
# Ralplan (Consensus Planning Alias) — Grok Build Port

This skill is the Grok Build adaptation of the OMX `ralplan` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/ralplan/` when state is needed.
