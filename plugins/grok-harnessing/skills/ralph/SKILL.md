---
name: ralph
description: "Grok Build port of OMX `ralph`: Self-referential loop until task completion with architect verification"
user_invocable: true
metadata:
  package: "linalab-io-frakework/grok-build"
  source: "oh-my-codex/plugins/oh-my-codex/skills/ralph/SKILL.md"
  source_repo: "https://github.com/Yeachan-Heo/oh-my-codex"
  port_kind: "grok-skill-adapter"
---

# ralph — Grok Build Port

This skill is the Grok Build adaptation of the OMX `ralph` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/ralph/SKILL.md`
- Original description: Self-referential loop until task completion with architect verification
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/ralph/` when state is needed.
