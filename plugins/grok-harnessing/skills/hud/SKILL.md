---
name: hud
description: "Grok Build port of OMX `hud`: Show or configure the OMX HUD (two-layer statusline)"
user_invocable: true
metadata:
  package: "linalab-io-framework/grok-build"
  source: "oh-my-codex/plugins/oh-my-codex/skills/hud/SKILL.md"
  source_repo: "https://github.com/Yeachan-Heo/oh-my-codex"
  port_kind: "grok-skill-adapter"
---

# HUD Skill — Grok Build Port

This skill is the Grok Build adaptation of the OMX `hud` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/hud/SKILL.md`
- Original description: Show or configure the OMX HUD (two-layer statusline)
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/hud/` when state is needed.
