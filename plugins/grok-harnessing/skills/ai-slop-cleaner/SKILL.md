...
# AI Slop Cleaner Skill — Grok Build Port

This skill is the Grok Build adaptation of the OMX `ai-slop-cleaner` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/ai-slop-cleaner/` when state is needed.
