---
name: omx-setup
description: "Grok Build port of OMX `omx-setup`: Setup and configure oh-my-codex using current CLI behavior"
user_invocable: true
metadata:
  package: "linalab-io-frakework/grok-build"
  source: "oh-my-codex/plugins/oh-my-codex/skills/omx-setup/SKILL.md"
  source_repo: "https://github.com/Yeachan-Heo/oh-my-codex"
  port_kind: "grok-skill-adapter"
---

# OMX Setup — Grok Build Port

This skill is the Grok Build adaptation of the OMX `omx-setup` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/omx-setup/SKILL.md`
- Original description: Setup and configure oh-my-codex using current CLI behavior
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/omx-setup/` when state is needed.
