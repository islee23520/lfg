---
name: ultraqa
description: "Grok Build port of OMX `ultraqa`: Adversarial dynamic e2e QA workflow - generate hostile scenarios, test, verify, fix, report, and clean up"
user_invocable: true
metadata:
  package: "linalab-io-framework/grok-build"
  source: "oh-my-codex/plugins/oh-my-codex/skills/ultraqa/SKILL.md"
  source_repo: "https://github.com/Yeachan-Heo/oh-my-codex"
  port_kind: "grok-skill-adapter"
---

# UltraQA Skill — Grok Build Port

This skill is the Grok Build adaptation of the OMX `ultraqa` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/ultraqa/SKILL.md`
- Original description: Adversarial dynamic e2e QA workflow - generate hostile scenarios, test, verify, fix, report, and clean up
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/ultraqa/` when state is needed.
