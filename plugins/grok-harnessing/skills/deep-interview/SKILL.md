---
name: deep-interview
description: "Grok Build port of OMX `deep-interview`: Socratic deep interview with mathematical ambiguity gating before execution"
user_invocable: true
metadata:
  package: "linalab-io-framework/grok-build"
  source: "oh-my-codex/plugins/oh-my-codex/skills/deep-interview/SKILL.md"
  source_repo: "https://github.com/Yeachan-Heo/oh-my-codex"
  port_kind: "grok-skill-adapter"
---

# deep-interview — Grok Build Port

This skill is the Grok Build adaptation of the OMX `deep-interview` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/deep-interview/SKILL.md`
- Original description: Socratic deep interview with mathematical ambiguity gating before execution
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/deep-interview/` when state is needed.
