...
description: "Grok Build port of OMX `autoresearch-goal`: Durable professor-critic research workflow over Codex goal mode without reviving deprecated omx autoresearch"
user_invocable: true
metadata:
  package: "linalab-io-framework/grok-build"
  source: "oh-my-codex/plugins/oh-my-codex/skills/autoresearch-goal/SKILL.md"
  source_repo: "https://github.com/Yeachan-Heo/oh-my-codex"
  port_kind: "grok-skill-adapter"
---

# Autoresearch Goal — Grok Build Port

This skill is the Grok Build adaptation of the OMX `autoresearch-goal` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/autoresearch-goal/SKILL.md`
- Original description: Durable professor-critic research workflow over Codex goal mode without reviving deprecated omx autoresearch
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/autoresearch-goal/` when state is needed.
