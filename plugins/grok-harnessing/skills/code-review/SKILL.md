---
name: code-review
description: "Grok Build port of OMX `code-review`: Run a comprehensive code review"
user_invocable: true
metadata:
  package: "linalab-io-frakework/grok-build"
  source: "oh-my-codex/plugins/oh-my-codex/skills/code-review/SKILL.md"
  source_repo: "https://github.com/Yeachan-Heo/oh-my-codex"
  port_kind: "grok-skill-adapter"
---

# Code Review Skill — Grok Build Port

This skill is the Grok Build adaptation of the OMX `code-review` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/code-review/SKILL.md`
- Original description: Run a comprehensive code review
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/code-review/` when state is needed.
