---
name: autopilot
description: "Grok Build port of OMX `autopilot`: [OMX] Strict autonomous loop: $ralplan -> $ralph -> $code-review"
user_invocable: true
metadata:
  package: "linalab-io-frakework/grok-build"
  source: "oh-my-codex/plugins/oh-my-codex/skills/autopilot/SKILL.md"
  source_repo: "https://github.com/Yeachan-Heo/oh-my-codex"
  port_kind: "grok-skill-adapter"
---

# autopilot — Grok Build Port

This skill is the Grok Build adaptation of the OMX `autopilot` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/autopilot/SKILL.md`
- Original description: [OMX] Strict autonomous loop: $ralplan -> $ralph -> $code-review
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/autopilot/` when state is needed.
