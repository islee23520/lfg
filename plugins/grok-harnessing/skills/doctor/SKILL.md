---
name: doctor
description: "Grok Build port of OMX `doctor`: Diagnose and fix oh-my-codex installation issues"
user_invocable: true
metadata:
...
# Doctor Skill — Grok Build Port

This skill is the Grok Build adaptation of the OMX `doctor` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/doctor/SKILL.md`
- Original description: Diagnose and fix oh-my-codex installation issues
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/doctor/` when state is needed.
