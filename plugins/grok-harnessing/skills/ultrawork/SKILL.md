---
name: ultrawork
description: "Grok Build port of OMX `ultrawork`: Parallel execution engine for high-throughput task completion"
user_invocable: true
metadata:
  package: "linalab-io-framework/grok-build"
  source: "oh-my-codex/plugins/oh-my-codex/skills/ultrawork/SKILL.md"
  source_repo: "https://github.com/Yeachan-Heo/oh-my-codex"
  port_kind: "grok-skill-adapter"
---

# ultrawork — Grok Build Port

This skill is the Grok Build adaptation of the OMX `ultrawork` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/ultrawork/SKILL.md`
- Original description: Parallel execution engine for high-throughput task completion
...
5. Store durable workflow notes under `~/.grok/plugin-data/grok-build/ultrawork/` when state is needed.
