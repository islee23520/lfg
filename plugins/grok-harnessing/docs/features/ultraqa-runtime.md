...
Provide an OMX-like UltraQA entrypoint for Grok Build that creates adversarial QA scenarios, optionally executes verification commands, and persists run evidence.
...
- State path: `~/.grok/plugin-data/grok-build/runs/ultraqa-*.json`
- Current pointer: `~/.grok/plugin-data/grok-build/state/last-ultraqa.json`
