...
Provide an OMX-like deep interview entrypoint for Grok Build that records requirement questions and answers before implementation.
...
- State path: `~/.grok/plugin-data/grok-build/interviews/*.json`
- Current pointer: `~/.grok/plugin-data/grok-build/state/current-interview.json`
