...
Provide an OMX-like ultrawork entrypoint for Grok Build that tracks a batch of task items and their evidence durably.
...
- State path: `~/.grok/plugin-data/grok-build/runs/ultrawork/*.json`
- Current pointer: `~/.grok/plugin-data/grok-build/state/current-ultrawork.json`
