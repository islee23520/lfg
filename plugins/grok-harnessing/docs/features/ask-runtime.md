...
Provide an OMX-like ask entrypoint for Grok Build that records external advisor requests and can optionally execute them. The default is dry-run for safety.
...
- State path: `~/.grok/plugin-data/grok-build/runs/ask/*.json`
- Current pointer: `~/.grok/plugin-data/grok-build/state/last-ask.json`
