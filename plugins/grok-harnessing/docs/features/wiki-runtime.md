...
Provide an OMX-like project wiki for Grok Build: small durable notes, list, and keyword search stored under plugin data.
...
- State path: `~/.grok/plugin-data/grok-build/wiki/*.json`
