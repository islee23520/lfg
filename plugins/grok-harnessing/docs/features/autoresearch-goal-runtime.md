...
Provide an OMX-like autoresearch-goal entrypoint for Grok Build that records a durable research question, hypotheses, and professor-critic gate evidence.
...
- State path: `~/.grok/plugin-data/grok-build/runs/autoresearch-goal/*.json`
- Current pointer: `~/.grok/plugin-data/grok-build/state/current-autoresearch-goal.json`
