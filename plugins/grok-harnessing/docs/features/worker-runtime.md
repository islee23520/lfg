...
Provide an OMX-like worker protocol for Grok Build team mode: workers can ACK tasks, report results, and expose status durably.
...
- State path: `~/.grok/plugin-data/grok-build/state/workers/*.json`
