...
Provide an OMX-like planning command for Grok Build that creates durable checklist-style plan state before implementation work.
...
- State path: `~/.grok/plugin-data/grok-build/state/plans/*.json`
