...
Provide an OMX-like setup entrypoint for Grok Build that checks plugin installation files and records the marketplace install plan durably.
...
- State path: `~/.grok/plugin-data/grok-build/state/omx-setup.json`
