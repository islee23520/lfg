...
description: "LFG port of OMX `ai-slop-cleaner`: Run an anti-slop cleanup/refactor/deslop workflow"
user_invocable: true
metadata:
...
# AI Slop Cleaner Skill — LFG Port

This skill is the LFG adaptation of the OMX `ai-slop-cleaner` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/ai-slop-cleaner/SKILL.md`
- Original description: Run an anti-slop cleanup/refactor/deslop workflow
...
5. Store durable workflow notes under `.lfg/ai-slop-cleaner/` when state is needed.
