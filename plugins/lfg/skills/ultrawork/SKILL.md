---
name: ultrawork
description: "LFG port of OMX `ultrawork`: Parallel execution engine for high-throughput task completion"
user_invocable: true
metadata:
...
This skill is the LFG adaptation of the OMX `ultrawork` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `.lfg/ultrawork/` when state is needed.
