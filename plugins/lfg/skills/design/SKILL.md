---
name: design
description: "LFG port of OMX `design`: Canonical repo-local DESIGN.md workflow for product, UI/UX, and frontend decision source of truth"
user_invocable: true
metadata:
...
# Design Skill — LFG Port

This skill is the LFG adaptation of the OMX `design` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `.lfg/design/` when state is needed.
