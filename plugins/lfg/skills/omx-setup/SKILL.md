---
name: omx-setup
description: "LFG port of OMX `omx-setup`: Setup and configure oh-my-codex using current CLI behavior"
user_invocable: true
metadata:
...
This skill is the LFG adaptation of the OMX `omx-setup` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `.lfg/omx-setup/` when state is needed.
