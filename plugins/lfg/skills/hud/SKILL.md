---
name: hud
description: "LFG port of OMX `hud`: Show or configure the OMX HUD (two-layer statusline)"
user_invocable: true
metadata:
...
This skill is the LFG adaptation of the OMX `hud` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `.lfg/hud/` when state is needed.
