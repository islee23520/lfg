---
name: code-review
description: "LFG port of OMX `code-review`: Run a comprehensive code review"
user_invocable: true
metadata:
...
# Code Review Skill — LFG Port

This skill is the LFG adaptation of the OMX `code-review` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `.lfg/code-review/` when state is needed.
