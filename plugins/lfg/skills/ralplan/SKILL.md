---
name: ralplan
description: "LFG port of OMX `ralplan`: Alias for $plan --consensus"
user_invocable: true
metadata:
...
# Ralplan (Consensus Planning Alias) — LFG Port

This skill is the LFG adaptation of the OMX `ralplan` workflow from `oh-my-codex`.
...
- Source skill: `oh-my-codex/plugins/oh-my-codex/skills/ralplan/SKILL.md`
- Original description: Alias for $plan --consensus
...
5. Store durable workflow notes under `.lfg/ralplan/` when state is needed.
