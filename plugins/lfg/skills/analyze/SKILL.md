...
# Analyze — Read-Only Deep Analysis — LFG Port

This skill is the LFG adaptation of the OMX `analyze` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `.lfg/analyze/` when state is needed.
