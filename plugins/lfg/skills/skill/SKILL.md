---
name: skill
description: "LFG port of OMX `skill`: Manage local skills - list, add, remove, search, edit, setup wizard"
user_invocable: true
metadata:
...
# Skill Management CLI — LFG Port

This skill is the LFG adaptation of the OMX `skill` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `.lfg/skill/` when state is needed.
