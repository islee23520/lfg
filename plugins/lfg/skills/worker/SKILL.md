...
# Worker Skill — LFG Port

This skill is the LFG adaptation of the OMX `worker` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `.lfg/worker/` when state is needed.
