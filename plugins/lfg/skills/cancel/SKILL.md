...
# Cancel Skill — LFG Port

This skill is the LFG adaptation of the OMX `cancel` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `.lfg/cancel/` when state is needed.
