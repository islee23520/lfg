...
description: "LFG port of OMX `autoresearch-goal`: Durable professor-critic research workflow over Codex goal mode without reviving deprecated omx autoresearch"
user_invocable: true
metadata:
...
# Autoresearch Goal — LFG Port

This skill is the LFG adaptation of the OMX `autoresearch-goal` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `.lfg/autoresearch-goal/` when state is needed.
