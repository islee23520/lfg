---
name: deep-interview
description: "LFG port of OMX `deep-interview`: Socratic deep interview with mathematical ambiguity gating before execution"
user_invocable: true
metadata:
...
# deep-interview — LFG Port

This skill is the LFG adaptation of the OMX `deep-interview` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `.lfg/deep-interview/` when state is needed.
