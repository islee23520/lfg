...
# Doctor Skill — LFG Port

This skill is the LFG adaptation of the OMX `doctor` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `.lfg/doctor/` when state is needed.
