---
name: ultraqa
description: "LFG port of OMX `ultraqa`: Adversarial dynamic e2e QA workflow - generate hostile scenarios, test, verify, fix, report, and clean up"
user_invocable: true
metadata:
...
# UltraQA Skill — LFG Port

This skill is the LFG adaptation of the OMX `ultraqa` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `.lfg/ultraqa/` when state is needed.
