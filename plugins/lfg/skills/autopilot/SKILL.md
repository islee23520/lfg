---
name: autopilot
description: "LFG port of OMX `autopilot`: [OMX] Strict autonomous loop: $ralplan -> $ralph -> $code-review"
user_invocable: true
metadata:
...
This skill is the LFG adaptation of the OMX `autopilot` workflow from `oh-my-codex`.
...
5. Store durable workflow notes under `.lfg/autopilot/` when state is needed.
