...
| `artistry` | grok high + optional creative consultation | Unconventional, pattern-breaking, lateral | Creative Challenger — pattern-breaking bias attacks orthodox thinking |
