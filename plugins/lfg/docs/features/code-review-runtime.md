...
Provide an OMX-like code-review entrypoint for LFG that persists a lightweight review report from git evidence. This is not a replacement for the full reviewer workflow; it is a durable smoke/runtime layer.
...
- State path: `.lfg/runs/code-review/*.json`
- Current pointer: `.lfg/state/last-code-review.json`
