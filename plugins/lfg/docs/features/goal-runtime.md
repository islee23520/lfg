...
Provide durable goal state for LFG workflows. This is the primitive layer that `ultragoal` builds multi-goal plans on top of.
...
- State path: `.lfg/state/goals/*.json`
- Current pointer: `.lfg/state/current-goal.json`
