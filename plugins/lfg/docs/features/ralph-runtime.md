...
Provide an OMX-like Ralph loop entrypoint for LFG that tracks bounded iterations, stop condition, and evidence durably.
...
- State path: `.lfg/runs/ralph/*.json`
- Current pointer: `.lfg/state/current-ralph.json`
