...
Provide an OMX-like notification configuration entrypoint for LFG. MVP stores dry-run notification preferences only; it does not send network notifications.
...
- State path: `.lfg/state/notifications.json`
