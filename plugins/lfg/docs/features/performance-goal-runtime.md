...
Provide an OMX-like performance-goal entrypoint for LFG that records evaluator-gated optimization metrics and pass/fail evidence durably.
...
- State path: `.lfg/runs/performance-goal/*.json`
- Current pointer: `.lfg/state/current-performance-goal.json`
