...
Provide an OMX-like visual Ralph entrypoint for LFG that tracks UI target/reference matching iterations and visual verdict evidence durably.
...
- State path: `.lfg/runs/visual-ralph/*.json`
- Current pointer: `.lfg/state/current-visual-ralph.json`
