...
Provide an OMX-like ralplan entrypoint for LFG that records consensus planning steps and architect review evidence before execution.
...
- State path: `.lfg/runs/ralplan/*.json`
- Current pointer: `.lfg/state/current-ralplan.json`
