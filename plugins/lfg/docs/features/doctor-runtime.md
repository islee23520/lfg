...
Provide an OMX-like doctor command for LFG that can quickly prove whether the plugin package, runtime, team backend prerequisites, and optional agent CLIs are discoverable.
