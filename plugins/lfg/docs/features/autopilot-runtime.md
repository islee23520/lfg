...
Provide an OMX-like autopilot entrypoint for LFG that records the strict `ralplan -> ralph -> code-review` loop as durable workflow state.
...
- State path: `.lfg/runs/autopilot/*.json`
- Current pointer: `.lfg/state/current-autopilot.json`
