...
Provide an OMX-like autoresearch entrypoint for LFG that records research questions and source notes durably. MVP does not browse automatically; it stores evidence gathered by Grok or the user.
...
- State path: `.lfg/runs/autoresearch/*.json`
- Current pointer: `.lfg/state/current-research.json`
