...
Provide an OMX-like pipeline command for LFG that tracks staged workflow progress with durable state.
...
- State path: `.lfg/state/pipelines/*.json`
- Current pointer: `.lfg/state/current-pipeline.json`
