// @bun
// vendor/omo-standalone/packages/utils/src/deep-merge.ts
...
// vendor/omo-standalone/packages/utils/src/snake-case.ts
...
function objectToCamelCase(obj, deep = true) {
  return transformObjectKeys(obj, snakeToCamel, deep);
}
// vendor/omo-standalone/packages/utils/src/record-type-guard.ts
function isRecord(value) {
  return typeof value === "object" && value !== null;
}
// vendor/omo-standalone/packages/utils/src/extract-semver.ts
...
// vendor/omo-standalone/node_modules/.bun/js-yaml@4.1.1/node_modules/js-yaml/dist/js-yaml.mjs
...
// vendor/omo-standalone/packages/utils/src/frontmatter.ts
...
// vendor/omo-standalone/packages/utils/src/file-utils.ts
...
// vendor/omo-standalone/packages/utils/src/contains-path.ts
...
// vendor/omo-standalone/packages/utils/src/port-utils.ts
import { createServer } from "net";
var DEFAULT_SERVER_PORT = 4096;
var MAX_PORT_ATTEMPTS = 20;
var PORT_CHECK_TIMEOUT_MS = 2000;
...
// vendor/omo-standalone/packages/utils/src/tool-name.ts
...
// vendor/omo-standalone/packages/utils/src/replace-tool-args.ts
function replaceToolArgs(output, patch) {
  output.args = { ...output.args, ...patch };
}
// vendor/omo-standalone/packages/utils/src/format-duration.ts
...
// vendor/omo-standalone/packages/utils/src/jsonc-parser.ts
import { existsSync as existsSync2, readFileSync } from "fs";
import { join as join2 } from "path";

// vendor/omo-standalone/node_modules/.bun/jsonc-parser@3.3.1/node_modules/jsonc-parser/lib/esm/impl/scanner.js
...
// vendor/omo-standalone/node_modules/.bun/jsonc-parser@3.3.1/node_modules/jsonc-parser/lib/esm/impl/string-intern.js
...
// vendor/omo-standalone/node_modules/.bun/jsonc-parser@3.3.1/node_modules/jsonc-parser/lib/esm/impl/parser.js
var ParseOptions;
...
// vendor/omo-standalone/node_modules/.bun/jsonc-parser@3.3.1/node_modules/jsonc-parser/lib/esm/main.js
var ScanError;
(function(ScanError2) {
...
function clearPluginConfigFileDetectionCache() {
  pluginConfigFileDetectionCache.clear();
}
function detectPluginConfigFile(dir, options) {
  ...
  const canonicalResult = detectConfigFile(join2(dir, canonicalBasename));
  const legacyResults = (options.legacyBasenames ?? []).map((legacyBasename) => detectConfigFile(join2(dir, legacyBasename)));
  ...
  if (canonicalResult.format !== "none") {
    ...
    detectionResult = { format: "none", path: join2(dir, `${canonicalBasename}.json`) };
  }
