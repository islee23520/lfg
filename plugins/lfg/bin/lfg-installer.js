...
const LAZYCODEX_INSTALLER_ARGS = ["lazycodex-ai", "install"];
const LAZYCODEX_INSTALLER_COMMAND = "npx lazycodex-ai install";
const LFP_INSTALLER_ARGS = [];
const LFP_INSTALLER_COMMAND = INTERNAL_GROK_INSTALL_COMMAND;
...
export {
  LAZYCODEX_INSTALLER_ARGS,
  LAZYCODEX_INSTALLER_COMMAND,
  LFP_INSTALLER_ARGS,
  LFP_INSTALLER_COMMAND,
  runLazycodexInstaller
};
