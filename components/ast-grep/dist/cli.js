...
if (sub === 'mcp' || sub === '') {
  forward(['/Users/ilseoblee/.grok/installed-plugins/lfg/node_modules/@code-yeongyu/ast-grep-mcp/dist/cli.js', 'mcp']);
} else if (sub === 'hook') {
  forward(['/Users/ilseoblee/.grok/installed-plugins/lfg/components/ast-grep/dist/cli.js', ...args]);
} else {
