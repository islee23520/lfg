...
if (sub === 'mcp' || sub === '') {
  forward(['/Users/ilseoblee/.grok/installed-plugins/lfg/components/git-bash/dist/cli.js', 'mcp']);
} else if (sub === 'hook') {
  forward(['/Users/ilseoblee/.grok/installed-plugins/lfg/components/git-bash/dist/cli.js', ...args]);
} else {
