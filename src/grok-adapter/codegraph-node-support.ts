/**
 * Codegraph Node-version support check.
 *
 * Ported verbatim from `oh-my-openagent` `packages/utils/src/codegraph/node-support.ts`.
 * CodeGraph is known to crash mid-indexing on Node >= 25 and requires Node >= 20.
