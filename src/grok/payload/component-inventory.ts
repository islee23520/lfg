...
export const COMPONENTS = [
  ...
  { id: "teammode", status: "Deferred", evidence: "Upstream 4.13.0 teammode skill payload is installed as an upstream-derived skill, but the Codex codex_app thread orchestration hook is not Grok-adapted yet (host dependency class: codex_app)." },
  { id: "lazycodex-executor-verify", status: "Deferred", evidence: "Upstream 4.13.0 SubagentStop evidence verifier targets the Codex lazycodex-executor agent and requires Grok-specific agent naming/event adaptation before it can be enabled (host dependency class: Stop/SubagentStop hook)." },
