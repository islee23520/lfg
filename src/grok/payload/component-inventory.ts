...
export const COMPONENTS = [
  ...
  { id: "workflow-selector", status: "Deferred", evidence: "Upstream omo-codex removed workflow-selector from the plugin components tree (#5745; absent on v4.16.3). lfg retains optional native lfg-native-workflow-selector.mjs (opt-in OMO_CODEX_AUTO_WORKFLOW) with temp-home proof only — historical lfg asset, not current upstream codex component debt. No Grok-adapted claim without authenticated GrokBuild host receipt." },
  { id: "difficulty-tier-workers", status: "Deferred", evidence: "Upstream v4.16.x lazycodex-worker-low|medium|high agents + difficulty-tier start-work/ulw-loop routing (PR #6030 family). Not Grok-adapted: no host-enforced difficulty tier dispatch on GrokBuild; document + optional agent TOML sync residual only." },
