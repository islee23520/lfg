...
export function createLfgBugFixPrBody(value) {
...
---
This PR was debugged, implemented, and created with [lfg](https://github.com/islee23520/lfg).
Tag: lfg-generated
`;
}
...
async function main() {
	...
	await writeFile(outputPath, createLfgBugFixPrBody(parsed), "utf8");
}
