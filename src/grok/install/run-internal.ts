...
import { installGrokPluginFromSource, overlayLfgComponentShims, readGrokInstallStamp } from "../payload/install"
import { readLfgPackageVersionFromBundle } from "../payload/package-version"
import { resolveLazycodexGrokPluginSource } from "../payload/resolve-lazycodex-plugin-source"
import { resolveOmoPayloadSource } from "../payload/resolve-omo-payload-source"
...
import { writeComponentInventory } from "../payload/component-inventory"
...
function defaultFixtureSourceRoot(): string {
  ...
  const candidates = [
    join(here, "grok-install", "fixture"),
    join(here, "fixture"),
    join(here, "..", "fixture"),
    join(here, "..", "grok-install", "fixture"),
    join(here, "..", "..", "grok-install", "fixture"),
