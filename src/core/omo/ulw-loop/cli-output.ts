...
export const ULW_LOOP_HELP = `Usage:
  lfg ulw-loop create-goals --brief "..." [--brief-file <path>] [--from-stdin] [--codex-goal-mode aggregate|per_story] [--force] [--json]
  lfg ulw-loop status [--json]
  lfg ulw-loop complete-goals [--retry-failed] [--json]
  lfg ulw-loop criteria --goal-id <id> [--json]
  lfg ulw-loop record-evidence --goal-id <id> --criterion-id <id> --status pass|fail|blocked --evidence "..." [--notes "..."] [--json]
  lfg ulw-loop checkpoint --goal-id <id> --status complete|failed|blocked --evidence "..." --codex-goal-json <...> [--quality-gate-json <...>] [--json]
  lfg ulw-loop steer --kind <kind> ... --evidence "..." --rationale "..." [--json]
  lfg ulw-loop add-goal --title "..." --objective "..." [--json]
  lfg ulw-loop record-review-blockers --goal-id <id> --title "..." --objective "..." --evidence "..." --codex-goal-json <...> [--json]
